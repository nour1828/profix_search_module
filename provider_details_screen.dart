            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    "Highly skilled professional with years of experience. Committed to providing the best service to all clients.",
        ...
        child: Row(
          children: [
            Container(
              ...
              child: IconButton(
                onPressed: () {},
                icon: const Icon(Icons.phone, color: Colors.cyanAccent),
              ),
            ),
